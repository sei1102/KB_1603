...
extern "C"  String_t* WWW_get_data_m3754151602 (WWW_t3134621005 * __this, const MethodInfo* method)
{
	{
		String_t* L_0 = WWW_get_text_m4216049525(__this, /*hidden argument*/NULL);
		return L_0;
	}
}
