...
struct  NetworkConnectionError_t1049203712 
{
public:
...
public:
	inline static int32_t get_offset_of_value___1() { return static_cast<int32_t>(offsetof(NetworkConnectionError_t1049203712, ___value___1)); }
